...
export const fetchPlaylistRequest = (payload) => ({
...
export const fetchPlaylistError = (payload) => ({
  type: FETCH_PLAYLIST_ERROR,
  payload,
});

export const toggleVideoCompleted = (payload) => ({
  type: TOGGLE_VIDEO_COMPLETED,
  payload,
});
export const toggleVideoOpen = (payload) => ({
  type: TOGGLE_VIDEO_OPEN,
  payload,
});
